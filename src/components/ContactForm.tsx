  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // No mail provider wired up yet: open the visitor's mail client with the
        ...
        if (data.fallback === "mailto") {
          ...
          window.location.href = `mailto:divyanshutiwari337@gmail.com?subject=${subject}&body=${body}`;
          toast({
            title: "Opening your mail app",
            description: "Just hit send and it lands in my inbox.",
